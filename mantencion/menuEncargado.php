      ...
      <!-- fin sideBar -->
        ...
        <div id="content" class="bg-light w-100">
              ...
              <section class="bg-light border-bottom ">
                  <div class="container"> 
                            <h1 class="font-weight-bold py-4 text-center mb-0">Areá de mantención de instalaciones <br> Condominio: <?php echo $_SESSION["nombre_condominio"] ?>  </h1>
                </div>
              </section>
              ...
              <h5 class="py-2 font-weight-bold border-bottom " style="text-align: start ;" ><i class="bi bi-chevron-right"></i>Opciones de registro y control de mantenciones </h5>
                      ...
                      <div class="herramienta d-inline-flex my-2  " style="margin-left: 5%; margin-right:5%; ">
                       <a href="../calendarioEncargado" class="btn-herramienta" >
                       ...
                       <div class="herramienta  d-inline-flex my-2  " style="margin-left: 5%; margin-right:5%;">
                       <a href="../tools/listarMantencionesEncargado.php" class="btn-herramienta" >
                ...
                <div class="container pb-2 bg-light ">
                      ...
                      $result = $con->query("SELECT * FROM mantencion WHERE estado != 1 AND fecha_inicio between '2022-07-01' and '2022-07-30' AND id_encargado = '".$idEncargado."'");
                ...
                <div class="container pb-5 bg-light">
                        ...
                        <table id="notificaciones2" class="table table-striped w-75 border">
                            ...
                            <?php
                      include ('../calendarioEncargado/config.php');
                      $result = $con->query("SELECT * FROM mantencion WHERE estado = 1 AND id_encargado = '".$encargado."'");
                       while( $data = mysqli_fetch_array($result)){
                      ?>
                      <tr align="left">
